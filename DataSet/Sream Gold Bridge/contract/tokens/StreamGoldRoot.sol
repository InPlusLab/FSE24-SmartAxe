...
contract CacheGold is IERC20, Ownable {
  ...
  // ERC20 Detailed Info
  /* solhint-disable */
  string public constant name = "Stream Gold";
  ...
  // vault for Stream Gold tokens to be minted, they are created in the backed_treasury
  ...
  // When gold bars are locked, we add Stream Gold tokens to circulation either
  ...
  /**
   * @dev Constructor for the Stream Gold token sets internal addresses
  ...
  */
  ...
  /**
  * @dev Approve the passed address to spend the specified amount of Stream Gold tokens on behalf of msg.sender.
  ...
  */
  ...
  /**
  * @dev Function to add a certain amount of backed Stream Gold tokens. This will first
  * take any Stream Gold tokens from the _unbackedTreasury address and move them to the
  ...
  * in special circumstance for gold storage addresses owed by Stream Protocol, exchanges, etc.
  ...
  * @return A uint256 representing the total number of Stream Gold tokens in circulation
  */
  ...
  */
  function _transfer(address from, address to, uint256 value) internal {
    ...
    if (storageFeeTo > 0) {
      ...
      // 3. A year later, the user receives more Stream Gold tokens. Because
  ...
  * addBackedTokens.
  * @param value The amount of Stream Gold tokens to mint to backed treasury
  * @return A boolean that indicates if the operation was successful.
  */
