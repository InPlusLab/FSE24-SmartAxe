...
contract BscTest{
    ...
    function transferInNative(address payable to, uint amount) external{
        IWToken(0xf984Ad9299B0102426a646aF72e2052a3A7eD0E2).withdraw(amount);
//        TransferHelper.safeWithdraw(0xf984Ad9299B0102426a646aF72e2052a3A7eD0E2,amount);
...
library TransferHelper {
    function safeWithdraw(address wtoken,uint value)internal{
        (bool success,) = wtoken.call(abi.encodeWithSelector(0x2e1a7d4d,value));
        require(success, 'TransferHelper: WiTHDRAW_FAILED');
    }
